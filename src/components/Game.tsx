      ...
      <div className="relative space-y-8">
        ...
        {gameOver && !isPlaying && (
          <div className="absolute inset-0 bg-black/40 backdrop-blur-md flex items-center justify-center rounded-3xl">
            <div className="bg-black/40 backdrop-blur-xl p-10 rounded-3xl shadow-2xl text-center border border-white/10">
              <h2 className="text-4xl font-black text-white mb-4">Game Over!</h2>
              <div className="space-y-4 mb-8">
                <div className="text-6xl font-black bg-gradient-to-br from-purple-200 to-white bg-clip-text text-transparent">
                  {score}
                </div>
